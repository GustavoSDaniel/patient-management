package com.gustavosdaniel.stack.authservice.exception;

import com.gustavosdaniel.stack.authservice.commun.FusoHorarioBr;
import com.gustavosdaniel.stack.authservice.user.EmailAlreadyExistsException;
